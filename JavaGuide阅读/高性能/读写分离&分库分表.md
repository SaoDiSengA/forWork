...
## [#](https://javaguide.cn/high-performance/read-and-write-separation-and-library-subtable.html#读写分离)读写分离

### [#](https://javaguide.cn/high-performance/read-and-write-separation-and-library-subtable.html#何为读写分离)何为读写分离？
...
### [#](https://javaguide.cn/high-performance/read-and-write-separation-and-library-subtable.html#读写分离会带来什么问题-如何解决)读写分离会带来什么问题？如何解决？
...
### [#](https://javaguide.cn/high-performance/read-and-write-separation-and-library-subtable.html#如何实现读写分离)如何实现读写分离？
...
### [#](https://javaguide.cn/high-performance/read-and-write-separation-and-library-subtable.html#主从复制原理了解么)主从复制原理了解么？
...
## [#](https://javaguide.cn/high-performance/read-and-write-separation-and-library-subtable.html#分库分表)分库分表
...
### [#](https://javaguide.cn/high-performance/read-and-write-separation-and-library-subtable.html#何为分库)何为分库？
...
### [#](https://javaguide.cn/high-performance/read-and-write-separation-and-library-subtable.html#何为分表)何为分表？
...
[《从零开始学架构》open in new window](https://time.geekbang.org/column/intro/100006601?code=i00Nq3pHUcUj04ZWy70NCRl%2FD2Lfj8GVzcGzZ3Wf5Ug%3D) 中的有一张图片对于垂直拆分和水平拆分的描述还挺直观的。

![img](https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/java-guide-blog/662ea3bda90061d0b40177e3a46fefc3.jpg)

### [#](https://javaguide.cn/high-performance/read-and-write-separation-and-library-subtable.html#什么情况下需要分库分表)什么情况下需要分库分表？
...
### [#](https://javaguide.cn/high-performance/read-and-write-separation-and-library-subtable.html#分库分表会带来什么问题呢)分库分表会带来什么问题呢？
...
### [#](https://javaguide.cn/high-performance/read-and-write-separation-and-library-subtable.html#分库分表有没有什么比较推荐的方案)分库分表有没有什么比较推荐的方案？
...
### [#](https://javaguide.cn/high-performance/read-and-write-separation-and-library-subtable.html#分库分表后-数据怎么迁移呢)分库分表后，数据怎么迁移呢？
