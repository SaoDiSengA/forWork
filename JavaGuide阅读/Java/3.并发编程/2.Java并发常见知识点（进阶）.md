...
### [#](https://javaguide.cn/java/concurrent/java-concurrent-questions-02.html#_5-1-介绍一下-atomic-原子类)5.1. 介绍一下 Atomic 原子类
...
### [#](https://javaguide.cn/java/concurrent/java-concurrent-questions-02.html#_5-2-juc-包中的原子类是哪-4-类)5.2. JUC 包中的原子类是哪 4 类?
...
### [#](https://javaguide.cn/java/concurrent/java-concurrent-questions-02.html#_5-3-讲讲-atomicinteger-的使用)5.3. 讲讲 AtomicInteger 的使用
...
### [#](https://javaguide.cn/java/concurrent/java-concurrent-questions-02.html#_5-4-能不能给我简单介绍一下-atomicinteger-类的原理)5.4. 能不能给我简单介绍一下 AtomicInteger 类的原理
...
关于 Atomic 原子类这部分更多内容可以查看我的这篇文章：并发编程面试必备：[JUC 中的 Atomic 原子类总结open in new window](https://mp.weixin.qq.com/s?__biz=Mzg2OTA0Njk0OA==&mid=2247484834&idx=1&sn=7d3835091af8125c13fc6db765f4c5bd&source=41#wechat_redirect)

## [#](https://javaguide.cn/java/concurrent/java-concurrent-questions-02.html#_6-aqs)6. AQS

### [#](https://javaguide.cn/java/concurrent/java-concurrent-questions-02.html#_6-1-aqs-介绍)6.1. AQS 介绍
...
### [#](https://javaguide.cn/java/concurrent/java-concurrent-questions-02.html#_6-2-aqs-原理分析)6.2. AQS 原理分析
...
#### [#](https://javaguide.cn/java/concurrent/java-concurrent-questions-02.html#_6-2-1-aqs-原理概览)6.2.1. AQS 原理概览
...
#### [#](https://javaguide.cn/java/concurrent/java-concurrent-questions-02.html#_6-2-2-aqs-对资源的共享方式)6.2.2. AQS 对资源的共享方式
...
#### [#](https://javaguide.cn/java/concurrent/java-concurrent-questions-02.html#_6-2-3-aqs-底层使用了模板方法模式)6.2.3. AQS 底层使用了模板方法模式
...
### [#](https://javaguide.cn/java/concurrent/java-concurrent-questions-02.html#_6-3-aqs-组件总结)6.3. AQS 组件总结

- **`Semaphore`(信号量)-允许多个线程同时访问：** `synchronized` 和 `ReentrantLock` 都是一次只允许一个线程访问某个资源，`Semaphore`(信号量)可以指定多个线程同时访问某个资源。
- **`CountDownLatch `（倒计时器）：** `CountDownLatch` 是一个同步工具类，用来协调多个线程之间的同步。这个工具通常用来控制线程等待，它可以让某一个线程等待直到倒计时结束，再开始执行。
- **`CyclicBarrier`(循环栅栏)：** `CyclicBarrier` 和 `CountDownLatch` 非常类似，它也可以实现线程间的技术等待，但是它的功能比 `CountDownLatch` 更加复杂和强大。主要应用场景和 `CountDownLatch` 类似。`CyclicBarrier` 的字面意思是可循环使用（`Cyclic`）的屏障（`Barrier`）。它要做的事情是，让一组线程到达一个屏障（也可以叫同步点）时被阻塞，直到最后一个线程到达屏障时，屏障才会开门，所有被屏障拦截的线程才会继续干活。`CyclicBarrier` 默认的构造方法是 `CyclicBarrier(int parties)`，其参数表示屏障拦截的线程数量，每个线程调用 `await()` 方法告诉 `CyclicBarrier` 我已经到达了屏障，然后当前线程被阻塞。

### [#](https://javaguide.cn/java/concurrent/java-concurrent-questions-02.html#_6-4-用过-countdownlatch-么-什么场景下用的)6.4. 用过 CountDownLatch 么？什么场景下用的？
