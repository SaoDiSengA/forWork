...
## [#](https://javaguide.cn/java/basis/bigdecimal.html#bigdecimal-的用处)BigDecimal 的用处

《阿里巴巴 Java 开发手册》中提到：**浮点数之间的等值判断，基本数据类型不能用==来比较，包装数据类型不能用 equals 来判断。**

![img](https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/javaguide/image-20211213101646884.png)
...
## [#](https://javaguide.cn/java/basis/bigdecimal.html#bigdecimal-常见方法)BigDecimal 常见方法

### [#](https://javaguide.cn/java/basis/bigdecimal.html#加减乘除)加减乘除
...
### [#](https://javaguide.cn/java/basis/bigdecimal.html#大小比较)大小比较
...
### [#](https://javaguide.cn/java/basis/bigdecimal.html#保留几位小数)保留几位小数
...
## [#](https://javaguide.cn/java/basis/bigdecimal.html#bigdecimal-的使用注意事项)BigDecimal 的使用注意事项
